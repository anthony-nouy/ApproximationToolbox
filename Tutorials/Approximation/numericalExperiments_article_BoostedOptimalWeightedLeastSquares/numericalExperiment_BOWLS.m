...
parfor k = 1:nbrepet
    ...
    yBLS1 = fun(xBLS1);
    fBLS1 = ls.solve(WBLS1*yBLS1,WBLS1*ABLS1);
    ...
    yBLS2 = fun(xBLS2);
    fBLS2 = ls.solve(WBLS2*yBLS2,WBLS2*ABLS2);
...
for k = 1:nbrepet
    ...
    WBLS = diag(sqrt(m*1./sum(ABLS.^2,2)));
    yBLS = fun(xBLS);
    fBLS = ls.solve(WBLS*yBLS,WBLS*ABLS);
    ...
    WSBLS = diag(sqrt(m*1./sum(ASBLS.^2,2)));
    ySBLS = fun(xSBLS);
    fSBLS = ls.solve(WSBLS*ySBLS,WSBLS*ASBLS);
